...
export default function TermsConditions() {
	return (
		<View class="flex flex-col">
			<Hero img={Reading} title="Terms & Conditions" subtitle="Welcome to Petsy!" />

			<p className={pClassList}>
				These terms and conditions outline the rules and regulations for the use
				of Petsy's Website, located at localhost:3001.
			</p>

			<p className={pClassList}>
				By accessing this website we assume you accept these terms and
				conditions. Do not continue to use Petsy if you do not agree to take all
			...
			<h3 className={headingClassList}>Cookies</h3>

			<p className={pClassList}>
				We employ the use of cookies. By accessing Petsy, you agreed to use
				cookies in agreement with the Petsy's Privacy Policy.
			</p>
			...
			<h3 className={headingClassList}>License</h3>

			<p className={pClassList}>
				Unless otherwise stated, Petsy and/or its licensors own the intellectual
				property rights for all material on Petsy. All intellectual property
				rights are reserved. You may access this from Petsy for your own
				personal use subjected to restrictions set in these terms and
				conditions.
			</p>

			<p className={pClassList}>You must not:</p>
			<ul className={ulClassList}>
				<li>Republish material from Petsy</li>
				<li>Sell, rent or sub-license material from Petsy</li>
				<li>Reproduce, duplicate or copy material from Petsy</li>
				<li>Redistribute content from Petsy</li>
			</ul>
			...
			<p className={pClassList}>
				...
				exchange opinions and information in certain areas of the website. Petsy
				...
				of Petsy,its agents and/or affiliates. Comments reflect the views and
				opinions of the person who post their views and opinions. To the extent
				permitted by applicable laws, Petsy shall not be liable for the Comments
			...
			<p className={pClassList}>
				Petsy reserves the right to monitor all Comments and to remove any
				Comments which can be considered inappropriate, offensive or causes
				breach of these Terms and Conditions.
			</p>

			<p className={pClassList}>You warrant and represent that:</p>
			...
			<p className={pClassList}>
				You hereby grant Petsy a non-exclusive license to use, reproduce, edit
				and authorize others to use, reproduce and edit any of your Comments in
				any and all forms, formats or media.
			</p>

			<h3 className={headingClassList}>Hyperlinking to our Content</h3>
			...
			<p className={pClassList}>
				...
				the hyperlink compensates the absence of Petsy; and (d) the link is in
			...
			<p className={pClassList}>
				...
				e-mail to Petsy. Please include your name, your organization name,
			...
			<p className={pClassList}>
				No use of Petsy's logo or other artwork will be allowed for linking
				absent a trademark license agreement.
			</p>

			<h3 className={headingClassList}>iFrames</h3>
			...
			<h3 className={headingClassList}>Content Liability</h3>
			...
			<h3 className={headingClassList}>Reservation of Rights</h3>
			...
			<h3 className={headingClassList}>Removal of links from our website</h3>
			...
			<h3 className={headingClassList}>Disclaimer</h3>
