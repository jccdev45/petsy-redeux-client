...
export function PrivacyPolicy() {
	return (
		<View class="flex flex-col">
			<Hero img={Reading} title="Privacy Policy" subtitle="Welcome to Petsy!" />
			...
			<p className={pClassList}>
				...
				of information that is collected and recorded by Petsy and how we use
				it.
			</p>
			...
			<h2 className={headingClassList}>Log Files</h2>

			<p className={pClassList}>
				Petsy follows a standard procedure of using log files. These files log
			...
			<h2 className={headingClassList}>Cookies and Web Beacons</h2>

			<p className={pClassList}>
				Like any other website, Petsy uses 'cookies'. These cookies are used to
			...
			<h2 className={headingClassList}>Google DoubleClick DART Cookie</h2>
			...
			<h2 className={headingClassList}>Our Advertising Partners</h2>
			...
			<ul>
				<li>
					<p className={pClassList}>Google</p>
					<p className={pClassList}>
						<a href="https://policies.google.com/technologies/ads">
							https://policies.google.com/technologies/ads
						</a>
			...
			<h2 className={headingClassList}>Privacy Policies</h2>

			<p className={pClassList}>
				You may consult this list to find the Privacy Policy for each of the
				advertising partners of Petsy.
			</p>

			<p className={pClassList}>
				Third-party ad servers or ad networks uses technologies like cookies,
				JavaScript, or Web Beacons that are used in their respective
				advertisements and links that appear on Petsy, which are sent directly
			...
			<p className={pClassList}>
				Note that Petsy has no access to or control over these cookies that are
				used by third-party advertisers.
			</p>

			<h2 className={headingClassList}>Third Party Privacy Policies</h2>

			<p className={pClassList}>
				Petsy's Privacy Policy does not apply to other advertisers or websites.
			...
			<h2 className={headingClassList}>Children's Information</h2>
			...
			<p className={pClassList}>
				Petsy does not knowingly collect any Personal Identifiable Information
			...
			<h2 className={headingClassList}>Online Privacy Policy Only</h2>

			<p className={pClassList}>
				This Privacy Policy applies only to our online activities and is valid
				for visitors to our website with regards to the information that they
				shared and/or collect in Petsy. This policy is not applicable to any
				information collected offline or via channels other than this website.
			</p>

			<h2 className={headingClassList}>Consent</h2>
